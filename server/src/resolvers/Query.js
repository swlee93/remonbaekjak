...
const { getReportInfos, getReportInfoByTimestamp } = require('./models/Reports')

module.exports = { getTasks, getLightHouseData, getSettings, getReportInfos, getReportInfoByTimestamp }
