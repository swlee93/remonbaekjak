...
const { getReportInfo, getReportInfoByTimestamp } = require('./models/Reports')

module.exports = { getTasks, getLightHouseData, getSettings, getReportInfo, getReportInfoByTimestamp }
