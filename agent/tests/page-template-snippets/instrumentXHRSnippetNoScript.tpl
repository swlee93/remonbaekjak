(function (w) {
  console.log('autoxhr-snippet.onload', !w.XMLHttpRequest || !new w.XMLHttpRequest().addEventListener);
  ...
  w.XMLHttpRequest = function () {
    ...
    xhr.open = function (method, url, async) {
      ...
      function addListener(ename, stat) {
        console.log('autoxhr-snippet.addListener', ename);
      ...
      try {
        ...
        xhr.send = function () {
          ...
          console.log('autoxhr-snippet.arguments', arguments);
